...
public enum BiomeElement {
    OCEAN(NORMAL, false, "SEAGRASS", DARK_BLUE),
    ...
    RIVER(NORMAL, false, "SUGAR_CANE", BLUE),
    ...
    DEEP_OCEAN(NORMAL, false, "KELP", DARK_BLUE),
    ...
    WARM_OCEAN(NORMAL, false, "FIRE_CORAL_BLOCK", AQUA),
    LUKEWARM_OCEAN(NORMAL, false, "HORN_CORAL_BLOCK", DARK_AQUA),
    COLD_OCEAN(NORMAL, false, "BUBBLE_CORAL_BLOCK", BLUE),
    DEEP_LUKEWARM_OCEAN(NORMAL, false, "BRAIN_CORAL_BLOCK", BLUE),
    DEEP_COLD_OCEAN(NORMAL, false, "TUBE_CORAL_BLOCK", DARK_BLUE),
    ...
    GROVE(NORMAL, false, "SNOW_BLOCK", WHITE),
    SNOWY_SLOPES(NORMAL, false, "SNOW_BLOCK", WHITE),
    FROZEN_PEAKS(NORMAL, false, "ICE", BLUE),
    JAGGED_PEAKS(NORMAL, false, "SNOW_BLOCK", WHITE),
    ...
    END_MIDLANDS(World.Environment.THE_END, false, "END_STONE", DARK_PURPLE),
